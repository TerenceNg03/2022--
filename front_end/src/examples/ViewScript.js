...
const ScriptSample = {
    main: '腹胀腹泻腹痛伴呕吐1天',
    present: '患者今凌晨开始腹部胀气，腹痛阵发,位于脐周，便前出现，便后缓解,腹泻2次。现测体温38°C,无鼻塞流涕，无感冒咳嗽，遂转至发热门诊就诊',
    history: '否认新冠流行病学史',
    bodycheck: '一般情况好, 咽充血，双侧扁桃体无肿大。一般可, 腹软,肝脾肋下未及,全腹无压痛及反跳痛。',
    ...
    getFormMeta = () => {
        const meta = {
            ...
            fields: [
                ...
                { key: 'present', label: '现病史', labelCol: {style: {width: '15%'}} },
                { key: 'history', label: '既往史', labelCol: {style: {width: '15%'}} },
                { key: 'bodycheck', label: '体格检查', labelCol: {style: {width: '15%'}} },
                { key: 'checkast', label: '辅助检查', labelCol: {style: {width: '15%'}}, viewWidget: ViewCheckAST },
                {
                    key: 'diagnosis', label: '初步诊断', labelCol: {style: {width: '15%'}},
                    // tooltip: 'This is the tooltip.',
                },
                { key: 'suggest', label: '处理意见', labelCol: {style: {width: '15%'}}, viewWidget: ViewSuggest },
                { key: 'caution', label: '注意事项', labelCol: {style: {width: '15%'}} },
                { key: 'appendix', label: '健康教育', labelCol: {style: {width: '15%'}} },
            ],
        }
    ...
    render() {
        return (
            ...
            >
                ...
                <hr/>
                <FormBuilder meta={this.getFormMeta()} initialValues={ScriptSample} viewMode/>
                <hr/>

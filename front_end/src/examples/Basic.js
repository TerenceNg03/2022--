...
export default class App extends Component {
    ...
    handleFinish = evt => {
        ...
        fetch(`/api/commit?id=${personalInfoSample.id}`,{
            ...
            body:JSON.stringify(this.formRef.current.getFieldsValue())
    ...
    getFormMeta = () => {
        const meta = {
            ...
            fields: [
                ...
                { key: 'pc', label: '注意事项', labelCol: {style: {width: '15%'}}, widget: 'textarea' },

...
func CollectRoute(r *gin.Engine) *gin.Engine {
	...
	r.GET("/api/record/view/:id", controller.GetRecord)
	r.POST("/api/record/newcase", controller.Register)
	r.POST("/api/record/commit", controller.CommitCase)
	return r
}
